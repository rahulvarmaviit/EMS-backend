    ...
    res.json({
      ...
      data: {
        attendance: attendance.map((a: any) => ({
          ...
          check_in_time: a.check_in_time,
          check_out_time: a.check_out_time,
          check_in_lat: a.check_in_lat ? Number(a.check_in_lat) : null,
          check_in_long: a.check_in_long ? Number(a.check_in_long) : null,
          check_out_lat: a.check_out_lat ? Number(a.check_out_lat) : null,
          check_out_long: a.check_out_long ? Number(a.check_out_long) : null,
          status: a.status,
          is_remote: a.is_remote,
          work_done: a.work_done,
          project_name: a.project_name,
